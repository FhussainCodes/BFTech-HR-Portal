...
<div class="container-fluid">
        ...
        <div class="card-body text-center">
            ...
            @if($user->profile_image)
                <div class="mt-2 d-flex justify-content-center gap-2">
                    {{-- Delete Image --}}
                    <form action="{{ route('hr.profile.deleteImage') }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
                    ...
                    {{-- Share on Facebook --}}
                    <button type="button" id="facebookShareBtn" class="btn btn-primary">
                        Share on Facebook
                    </button>
                </div>
            @endif
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('hr.profile.editPersonal') }}" class="btn btn-warning btn-sm">
                {{ __('profile.edit') }}
            </a>
        </div>
        <div class="card-body">
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('hr.profile.editContact') }}" class="btn btn-warning btn-sm">
                {{ __('profile.edit') }}
            </a>
        </div>
        <div class="card-body">
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('hr.profile.editDesignation') }}" class="btn btn-warning btn-sm">
                {{ __('profile.edit') }}
            </a>
        </div>
        <div class="card-body">
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('hr.profile.editOther') }}" class="btn btn-warning btn-sm">
                {{ __('profile.edit') }}
            </a>
        </div>
        <div class="card-body">
    ...
    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('hr.profile.editPassword') }}" class="btn btn-warning btn-sm">
...
document.getElementById('facebookShareBtn').addEventListener('click', function () {
    const shareUrl = "https://fragrance-legroom-bannister.ngrok-free.dev/profile/{{ $user->id }}";
