            ...
            <form action="{{ route('hr.leave.approved') }}" method="GET">
                <div class="row g-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end gap-2">
                        ...
                        <a href="{{ route('hr.leave.approved') }}" class="btn btn-secondary d-inline-flex align-items-center">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-4 text-muted">
                                    {{ Lang::has('leave.no_approved_records') ? __('leave.no_approved_records') : 'No Approved Leave Requests Found' }}
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
