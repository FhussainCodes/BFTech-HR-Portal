...
'designation' => [
    'required' => 'عہدہ درج کرنا ضروری ہے۔',
    'min'      => 'عہدہ کم از کم 2 حروف پر مشتمل ہونا چاہیے۔',
    'max'      => 'عہدہ 30 حروف سے زیادہ نہیں ہو سکتا۔',
    'regex'    => 'عہدہ میں صرف حروف اور اسپیس کی اجازت ہے۔',
],
'forgot_password' => [
    'email' => [
        'required' => 'براہ کرم اپنا رجسٹرڈ ای میل ایڈریس درج کریں۔',
        'email'    => 'براہ کرم درست ای میل ایڈریس درج کریں۔',
    ],
],
'profile_image' => [

    'required' => 'براہ کرم پروفائل تصویر اپ لوڈ کریں۔',
    'image'    => 'پروفائل تصویر ایک درست تصویر کی فائل ہونی چاہیے۔',
    'mimes'    => 'صرف JPG، JPEG، PNG اور WEBP فارمیٹس کی اجازت ہے۔',
    'max'      => 'پروفائل تصویر کا سائز 2 ایم بی سے زیادہ نہیں ہونا چاہیے۔',

],
'leave_type' => [
    'required' => 'براہ کرم چھٹی کی قسم منتخب کریں۔',
],

'from_date' => [
    'required'         => 'براہ کرم چھٹی کی شروعات کی تاریخ منتخب کریں۔',
    'date'             => 'براہ کرم درست شروعات کی تاریخ درج کریں۔',
    'after_or_equal'   => 'گزری ہوئی تاریخ کے لیے چھٹی کی درخواست نہیں دی جا سکتی۔',
],

'to_date' => [
    'required'         => 'براہ کرم چھٹی کے اختتام کی تاریخ منتخب کریں۔',
    'date'             => 'براہ کرم درست اختتامی تاریخ درج کریں۔',
    'after_or_equal'   => 'اختتامی تاریخ، شروعات کی تاریخ کے برابر یا اس کے بعد ہونی چاہیے۔',
],
'password' => [

    'required' => 'پاس ورڈ درج کرنا ضروری ہے۔',
    'min'      => 'آپ کا پاس ورڈ کم از کم 6 حروف پر مشتمل ہونا چاہیے۔',
    'max'      => 'آپ کا پاس ورڈ 64 حروف سے زیادہ نہیں ہو سکتا۔',

],
'city' => [

    'required' => 'شہر درج کرنا ضروری ہے۔',
    'min'      => 'شہر کا نام کم از کم 3 حروف پر مشتمل ہونا چاہیے۔',
    'max'      => 'شہر کا نام 20 حروف سے زیادہ نہیں ہو سکتا۔',
    'regex'    => 'شہر کے نام میں صرف حروف اور اسپیس کی اجازت ہے۔',

],

'country' => [

    'required' => 'ملک درج کرنا ضروری ہے۔',
    'min'      => 'ملک کا نام کم از کم 2 حروف پر مشتمل ہونا چاہیے۔',
    'max'      => 'ملک کا نام 25 حروف سے زیادہ نہیں ہو سکتا۔',
    'regex'    => 'ملک کے نام میں صرف حروف اور اسپیس کی اجازت ہے۔',

],
'first_name' => [

    'required' => 'براہ کرم اپنا پہلا نام درج کریں۔',
    'min'      => 'پہلا نام کم از کم 3 حروف پر مشتمل ہونا چاہیے۔',
    'max'      => 'پہلا نام 20 حروف سے زیادہ نہیں ہو سکتا۔',
    'regex'    => 'پہلے نام میں صرف حروف اور اسپیس کی اجازت ہے۔',

],

'last_name' => [

    'required' => 'آخری نام درج کرنا ضروری ہے۔',
    'min'      => 'آخری نام کم از کم 2 حروف پر مشتمل ہونا چاہیے۔',
    'max'      => 'آخری نام 35 حروف سے زیادہ نہیں ہو سکتا۔',
    'regex'    => 'آخری نام میں صرف حروف اور اسپیس کی اجازت ہے۔',

],

'age' => [

    'required' => 'براہ کرم اپنی عمر درج کریں۔',
    'integer'  => 'عمر ایک درست عدد ہونی چاہیے۔',
    'between'  => 'عمر 15 سے 70 سال کے درمیان ہونی چاہیے۔',

],
'password' => [

    'regex' => 'پاس ورڈ میں کم از کم ایک بڑا حرف، ایک چھوٹا حرف، ایک نمبر، اور ایک خاص کریکٹر (@$!%*?&) ہونا ضروری ہے۔',

],

'confirm_password' => [

    'required' => 'براہ کرم اپنے پاس ورڈ کی تصدیق کریں۔',
    'same'     => 'تصدیقی پاس ورڈ درج کیے گئے پاس ورڈ سے مطابقت نہیں رکھتا۔',

],
'otp' => [

    'required' => 'پاس ورڈ ری سیٹ کرنے کے لیے او ٹی پی درج کرنا ضروری ہے۔',
    'digits'   => 'او ٹی پی بالکل 6 ہندسوں پر مشتمل ہونا چاہیے۔',
